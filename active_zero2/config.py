...
_C.CGIStereo.LOGLINEAR_DISP_MIN_DEPTH = 0.04
_C.CGIStereo.LOGLINEAR_DISP_MAX_DEPTH = 3.0
_C.CGIStereo.LOGLINEAR_DISP_C = 0.01
_C.CGIStereo.PREDICT_NORMAL = False
_C.CGIStereo.PREDICT_NORMAL_V2 = False
...
_C.LOSS.EDGE = 1.0
_C.LOSS.SIM_NORMAL = 0.0
_C.LOSS.REAL_NORMAL = 0.0
